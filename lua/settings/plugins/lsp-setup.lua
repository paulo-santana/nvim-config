...
local on_attach = function(client, bufnr)
	...
	--buf_set_keymap('n', '<space>rn', '<cmd>lua vim.lsp.buf.rename()<CR>', opts) -- handled by saga
	--buf_set_keymap('n', 'gr', '<cmd>lua vim.lsp.buf.references()<CR>', opts) -- handled by trouble
...
local sumneko_root_path = '/home/paulo/.language-servers/lua-language-server'
